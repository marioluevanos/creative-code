...
password.addEventListener("click", onCopy);

gsap.set(".front .button", {
  opacity: 0,
  y: 16,
  pointerEvents: "none",
});
...
function pullOut() {
  if (openTrigger.dataset.init) return;

  openTrigger.dataset.init = "true";
...
function addCake() {
  const cakes = <HTMLDivElement>document.getElementById("cakes");
  cakes.classList.add("show");
  cakes.innerHTML = `
    <div class="velas">
                  <div class="fuego"></div>
                  <div class="fuego"></div>
